...
WS.sendRequestAndVerify(findTestObject('REST API/Add product', [('productName') : 'Produkt_testowy4']))
...
def productResponse = WS.sendRequestAndVerify(findTestObject('REST API/Get product', [('productId') : "${p4.id}"]))
...
WS.sendRequestAndVerify(findTestObject('REST API/Delete product', [('productId') : "${p4.id}"]))
